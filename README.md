...
#### Example usage:
* https://Timestamp-Microservice--freecodecamp.repl.co/api/timestamp/2022-03-17
*https://Timestamp-Microservice--freecodecamp.repl.co/api/timestamp/1451001600000

#### Example output:
* {"unix":1451001600000, "utc":"Thu, 17 Dec 2022 00:00:00 GMT"}

### Run This App
clone this git repo and install the dependacies at ```package.json``` file

npm start

locate the port e.g ```http://localhost:32051/``` and you will find the app.
